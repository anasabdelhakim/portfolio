      ...
      {appReady && (
        <>
          ...
          <motion.h1
            ...
            className="sm:text-9xl text-7xl max-xs:text-6xl font-extrabold will-change-transform"
          >
            {title}
          </motion.h1>
          ...
          >
            <Link to="projects">
              <button className="border-2 lg:text-lg sm:px-8 sm:py-3 px-4 py-2 text-sm max-xs:text-[12px] rounded-md hover:bg-background transition">
                See Projects
              </button>
            </Link>
            <Link to="contact">
